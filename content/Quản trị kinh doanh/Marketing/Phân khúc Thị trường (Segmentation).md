...
**Phân khúc Thị trường (Market Segmentation)** là quá trình phân chia một thị trường lớn, không đồng nhất (heterogeneous) thành các nhóm nhỏ hơn (gọi là các phân khúc) có những đặc điểm, nhu cầu, hoặc hành vi tương đồng (homogeneous) và đòi hỏi các chiến lược [[Marketing Hỗn hợp (Marketing Mix)|marketing mix (4P)]] riêng biệt.
...
1. **Đo lường được (Measurable):** Có thể đo lường được quy mô, sức mua, và đặc điểm của phân khúc.
2. **Tiếp cận được (Accessible):** Có thể tiếp cận và phục vụ phân khúc đó một cách hiệu quả (ví dụ: qua kênh phân phối, truyền thông).
3. **Đủ lớn (Substantial):** Phân khúc phải đủ lớn và có đủ lợi nhuận để theo đuổi.
4. **Khả thi (Actionable):** Có khả năng xây dựng các chương trình marketing (4P) riêng biệt để thu hút phân khúc đó.
5. **Khác biệt (Differentiable):** Các phân khúc phải có phản ứng khác biệt rõ rệt với các chương trình marketing mix khác nhau.
- "Quản_trị_Kinh_doanh"
- "Marketing"
- "Marketing_Chiến_lược_STP"
Up:
- "[[MOC - Marketing Chiến lược (STP)]]"
Related:
