...
- "Marketing_Dịch_vụ"
Up:
- "[[MOC - Chiến lược Sản phẩm (Product)]]"
Related:
...
Đây là thành phần cốt lõi của **[[Ba Cấp độ của Sản phẩm (Kotler)|Cấp độ 3: Sản phẩm Tăng cường (Augmented Product)]]**.

## 2. Vai trò (Công cụ Cạnh tranh)

Ở các thị trường bão hòa (ví dụ: điện thoại, xe máy), nơi mà [[Quyết định về Thuộc tính Sản phẩm|chất lượng và tính năng]] (Sản phẩm Hiện thực) của các đối thủ ngày càng giống nhau, thì Dịch vụ Hỗ trợ (Sản phẩm Tăng cường) trở thành **công cụ tạo khác biệt (differentiation) chính**.
...
Doanh nghiệp cần [[Nghiên cứu Định lượng (Quantitative Research)|khảo sát]] khách hàng để biết họ đánh giá cao những dịch vụ nào (ví dụ: giao hàng, lắp đặt, bảo hành, hướng dẫn sử dụng) và họ sẵn sàng *trả tiền* (hay mong đợi miễn phí) cho chúng.
